 ...
 * de tipo Boat, extiende de Vehicle.
...
public class Boat extends Vehicle {
     ...
     * @param motor ¿tiene motor?
     */
    public Boat(int passengers, int wheels, double speed,
                LocalDate registration, String displacementOn,
                String howToEnter, boolean crew, String id,
                String type, boolean motor)
    {
